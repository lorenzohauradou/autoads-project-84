                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="font-semibold text-xl">MAVEE</span>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 max-w-7xl mx-auto">
                        ...
                        <div className="space-y-4">
                            <div className="aspect-square bg-gradient-to-br from-slate-50 to-slate-100 rounded-2xl overflow-hidden shadow-sm">
                                <Image
                                    src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/e7bac579-f5b0-4d10-8b52-61b2252fedc3.jpg?"
                                    alt="MAVEE Elite Electric Scooter - Main View"
                                    width={600}
                                    height={600}
                            ...
                            <div className="grid grid-cols-4 gap-3">
                                {[
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/10b74f3d-e309-487d-94ab-f97a19a79c79.jpg?", alt: "MAVEE Elite side view" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/ec50be50-70cd-48bc-84fc-ac02b439c1c9.jpg?", alt: "MAVEE Elite handlebar details" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/021a3a84-417d-484d-8a27-f29ed6886974.jpg?", alt: "MAVEE Elite folded view" },
                                    { src: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d2c0914f-e0a7-4041-a5e5-1c1b50203332.jpg?", alt: "MAVEE Elite wheel close-up" },
                                ].map((image, i) => (
                                    <div
                                        key={i}
                        ...
                        <div className="space-y-6 lg:space-y-8">
                            <div className="space-y-4">
                                ...
                                <p className="text-lg text-slate-600 leading-relaxed max-w-lg">
                                    Experience premium sustainable transportation with industry-leading 60km range and intelligent energy recovery. Transform your daily commute into an effortless journey.
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                {[
                                    ...
                                    { icon: Gauge, text: "25km/h Max Speed" },
                            ...
                            <TabsContent value="features" className="mt-8">
                                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                    <div className="space-y-6">
                                        <h3 className="text-2xl font-bold text-slate-900">Why Choose MAVEE Elite?</h3>
                                        <div className="space-y-5">
                                            {[
                                                {
                                                    title: "Industry-Leading Range",
                                                    description: "Travel up to 60km on a single charge with our 477.36Wh lithium battery",
                                                },
                                                {
                                                    title: "Smart Energy Recovery",
                                                    description: "Innovative regenerative braking recaptures 15% of energy for extended rides",
                                                },
                                                {
                                                    title: "Three-Speed Control",
                                                    description: "Adapt to any urban environment with customizable speed settings",
                                                },
                                                {
                                                    title: "Premium Build Quality",
                                                    description: "Matte black finish with dual shock absorption for ultimate comfort",
                                                },
                                            ].map((feature, i) => (
                                    ...
                                    <div className="aspect-video bg-white rounded-2xl shadow-sm overflow-hidden flex items-center justify-center">
                                        <Image
                                            src="https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/021a3a84-417d-484d-8a27-f29ed6886974.jpg?"
                                            alt="MAVEE Elite features demonstration"
                                            width={480}
                                            height={360}
                                            className="w-full h-full object-cover"
                                        />
                                ...
                                <div className="grid lg:grid-cols-2 gap-8 lg:gap-12">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="bg-white rounded-2xl p-6 shadow-sm space-y-4">
                                            {[
                                                "1x MAVEE Elite Electric Scooter",
                                                "1x Smart Charger",
                                                "1x User Manual",
                                    ...
                                    <div className="space-y-6">
                                        {[
                                            ...
                                            },
                                            {
                                                ...
                                                content:
                                                    "Build quality is exceptional. The matte black finish looks sleek and the ride is incredibly smooth.",
                                            },
                                            {
                                                name: "James Lee",
                                                avatar: "JL",
                                                ...
                                                content:
                                                    "Love that I'm reducing my carbon footprint. The three speed modes are perfect for different traffic conditions.",
                                            },
                                        ].map((review, i) => (
                                        ...
                                        {[
                                            {
                                                ...
                                                answer:
                                                    "The 477.36Wh battery provides up to 60km range on a single charge. With the 15% energy recovery system, you can extend this even further during regular use.",
                                            },
                                            {
                                                question: "Is it suitable for daily commuting?",
                                                answer:
                                                    "Absolutely! The MAVEE Elite is designed specifically for urban commuters. The 60km range covers most daily commutes with room to spare.",
                                            },
                                            {
                                                question: "What's the charging time?",
                                                answer:
                                                    "Full charge takes approximately 4-5 hours with the included smart charger. The charger automatically stops when the battery is full.",
                                            },
                                            {
                                                question: "Can it handle hills?",
                                                answer:
                                                    "Yes, the powerful motor handles inclines up to 15 degrees comfortably, even at maximum load capacity of 120kg.",
                                            },
                                            {
                                                question: "What maintenance is required?",
                                                answer:
                                                    "Minimal maintenance needed - just regular tire pressure checks and occasional cleaning. The included tool kit covers basic maintenance needs.",
                                            },
                                        ].map((faq, i) => (
                                            <AccordionItem
                                                key={i}
                ...
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                            {[
                                { name: "Safety Helmet", price: "$49.99", image: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/d2c0914f-e0a7-4041-a5e5-1c1b50203332.jpg?" },
                                { name: "Phone Mount", price: "$24.99", image: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/ec50be50-70cd-48bc-84fc-ac02b439c1c9.jpg?" },
                                { name: "Lock & Chain", price: "$39.99", image: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/10b74f3d-e309-487d-94ab-f97a19a79c79.jpg?" },
                                { name: "Storage Bag", price: "$29.99", image: "https://beasahuotuicaipswzhe.supabase.co/storage/v1/object/public/uploads/021a3a84-417d-484d-8a27-f29ed6886974.jpg?" },
                            ].map((product, i) => (
                                <Card
                                    key={i}
            ...
            <footer className="border-t bg-slate-50 py-8">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                        ...
                        <p className="text-sm text-slate-600 text-center sm:text-right">© 2024 MAVEE. All rights reserved.</p>
                    </div>
                </div>
            </footer>
        </div>
